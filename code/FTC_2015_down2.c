...
task main()
{
   ...
   LR(-100, 1500); // go to space near the ramp
   rotate(1400); // rotate to 30cm goal
   LR(-100, 11000); //go to 30cm goal
   lift(100; 1000);   //{ put
   LR(-20; 500);     // the ball
   lift(-100; 1000);//  to 30cm goal}
   L(2000, 100);  // rotate to 90cm goal
   motion(5000, 1); // ride and capture to 90cm goal
   elevator(9000); // put the ball to 90cm goal
   R(1000, 100); // rotate to parking zone
   LR(1000, 100); // ride to parking zone and stop near the 30cm goal
   servo[servoMvClaws2] = 0; //capture 30cm goal
   motion(10000,-1); // go to the parking zone
   L(1000, 100); // rotate in the parking zone
