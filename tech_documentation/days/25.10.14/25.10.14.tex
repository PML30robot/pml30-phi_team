...
\begin{enumerate}
	...
	\begin{enumerate}
	  ...
	  \begin{enumerate}
	    ...
	    \begin{figure}[H]
	    	...
	    	\begin{minipage}[h]{0.6\linewidth}
	    		\center{\includegraphics[height=0.9\measurepage,width=1\linewidth]{days/25.10.14/images/01}}
      ...
      \begin{figure}[H]
      	...
      	\end{minipage}
      	\begin{minipage}[h]{0.6\linewidth}
      		\center{\includegraphics[width=1\linewidth]{days/25.10.14/images/01}}
