	...
	\begin{enumerate}
      ...
      \begin{figure}[H]
      	\begin{minipage}[h]{0.31\linewidth}
      		\center{\includegraphics[scale=0.2]{days/28.10.14/images/01}}
      		\caption{Servo}
      	\end{minipage}
      	\hfill
      	\begin{minipage}[h]{0.31\linewidth}
      		\center{\includegraphics[scale=0.15]{days/28.10.14/images/02}}
      		\caption{Hole for servo}
      	\end{minipage}
      	\hfill
      	\begin{minipage}[h]{0.31\linewidth}
      		\center{\includegraphics[scale=0.15]{days/28.10.14/images/03}}
