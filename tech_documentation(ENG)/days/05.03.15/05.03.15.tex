	...
	\begin{enumerate}
		 ...
		 \item The drawing of bucket was drew at the list of plastic.
		 		         \begin{figure}[H]
		 		         	...
		 		         	\begin{minipage}[h]{0.6\linewidth}
		 		         		\center{\includegraphics[scale=0.35]{days/05.03.15/images/01}}
		...
		\item The bucket was cut and fastened by stapler.
		 		         \begin{figure}[H]
		 		         	...
		 		         	\end{minipage}
		 		         	\begin{minipage}[h]{0.6\linewidth}
		 		         		\center{\includegraphics[scale=0.35]{days/05.03.15/images/02}}
		 		         		\caption{Bucket}
		 		         	\end{minipage}
		 		         \end{figure}	
		\item The piece of plastic that smooth corners was installed inside the bucket.	
		 		         \begin{figure}[H]
		 		         	...
		 		         	\end{minipage}
		 		         	\begin{minipage}[h]{0.6\linewidth}
		 		         		\center{\includegraphics[scale=0.35]{days/05.03.15/images/03}}
		...
		\item The corner that can hook the wire that connect MOB with servocontroller was cut. The patch was fixed on the cut part.
		 		         \begin{figure}[H]
		 		         	...
		 		         	\end{minipage}
		 		         	\begin{minipage}[h]{0.6\linewidth}
		 		         		\center{\includegraphics[scale=0.35]{days/05.03.15/images/04}}
		 		         		\caption{The patch}
		 		         	\end{minipage}
		 		         \end{figure}
